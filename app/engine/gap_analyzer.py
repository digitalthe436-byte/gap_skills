...
from app.config import REQUIRED_SKILL_WEIGHT, PREFERRED_SKILL_WEIGHT, SKILL_MATCH_RATIO, SEMANTIC_SIMILARITY_RATIO
from app.nlp.taxonomy import CATEGORY_META
...
def perform_gap_analysis(resume_text: str, jd_text: str) -> Dict[str, Any]:
    ...
    for cat_key, meta in CATEGORY_META.items():
        ...
        coverage_pct = round((matched_cat_skills / total_cat_skills) * 100.0, 1) if total_cat_skills > 0 else 100.0
